...
def start_server(server_ip, server_port, key_file, cert_file):
	bash_cmd = "openssl s_server -key ../OpenSSL/testkey.pem -cert ../OpenSSL/testcert.pem -WWW -cipher RC4-SHA -accept 8443 &"
	os.system(bash_cmd)
	
if __name__ == "__main__":
 	url_list = walk_directory_paths_and_construct_url_path('/home/deeks/Desktop/SSL_Task/html_files')
	print url_list
 	random_url_list = pick_random_url(url_list, 2)
